Vazul = {
    ...
    init = function()
        Vazul.player = {x=0, y=-100, z=20, rot_z=0, rot_zd=0, sin=0, cos=1, move_x = 0, move_y = Vazul.XY_SPEED}
        print("Vazul initialized")
    end,
    draw = function()
...
Vazul.update = function()
    if Vazul.button_A_pressed then
        Vazul.move_forward()
    end
    if Vazul.button_B_pressed then
        Vazul.move_backward()
    end
    if Vazul.button_LEFT_pressed then
        Vazul.turn_left()
    end
    if Vazul.button_RIGHT_pressed then
        Vazul.turn_right()
    end
end

Vazul.btn_A_pressed = function()
    Vazul.button_A_pressed = true
end

Vazul.btn_A_released = function()
    Vazul.button_A_pressed = false
end

Vazul.btn_B_pressed = function()
    Vazul.button_B_pressed = true
end

Vazul.btn_B_released = function()
    Vazul.button_B_pressed = false
end

Vazul.btn_LEFT_pressed = function()
    Vazul.button_LEFT_pressed = true
end

Vazul.btn_LEFT_released = function()
    Vazul.button_LEFT_pressed = false
end

Vazul.btn_RIGHT_pressed = function()
    Vazul.button_RIGHT_pressed = true
end

Vazul.btn_RIGHT_released = function()
    Vazul.button_RIGHT_pressed = false
end

Vazul.btn_UP_pressed = function()
    Vazul.button_UP_pressed = true
end

Vazul.btn_UP_released = function()
    Vazul.button_UP_pressed = false
end

Vazul.btn_DOWN_pressed = function()
    Vazul.button_DOWN_pressed = true
end

Vazul.btn_DOWN_released = function()
    Vazul.button_DOWN_pressed = false
end

Vazul.move_backward = function()
    Vazul.player.x = Vazul.player.x - Vazul.player.move_x
    Vazul.player.y = Vazul.player.y - Vazul.player.move_y
end

Vazul.calculate_2dpoints = function(p3d,translate)
...
Vazul.calculate_move_xy = function()
...
Vazul.infinity = function(n, lowest, highest)
    if n < lowest then
        n = n + (highest - lowest)
...
Vazul.round = function(num, decimals)
    local multiplier = 10^decimals
    return math.floor(num * multiplier + 0.5) / multiplier
end

Vazul.get_horizon = function()
    return {
        x1=0,
        y1=Vazul.height/2,
        x2=Vazul.width-1,
