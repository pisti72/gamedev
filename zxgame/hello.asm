...
pxltxt_skip2:      
    ld b,a
    ld a,(pxltxt_height) ;each char is 6 height
    inc a
    ld e,a
    ld d,0
pxltxt_loop3:
...
wider_loop3:
    ...
    djnz wider_loop3
wider_if_a:
    ld (spr2_bmp_addr),hl ;hl at the right char bmp addr
    ld a,(spr_y)
    ld (spr2_ytemp),a
    ld a,0
    ld (spr2_bmp_y),a
    ld a,(pxltxt_height)
    ld b,a ;each char is 6 height
wider_loop:
    push bc
    call spr2_calc
    ld hl,(spr2_bmp_addr)
    ...
    ld e,a
    ld d,0
    add hl,de ;load spr bmp data into de
    ld a,(hl)
    ld l,a
    ld de,0
    ;make it wider somehow :-)
    ld b,8
wider_loop5:
    ;ld a,l
    ;ld e,a
